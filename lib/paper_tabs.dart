...
class PaperTabs extends CoreSelector {
  ...
  bool get noslide => jsElement['noslide'];
  set noslide(bool value) { jsElement['noslide'] = value; }

  /// If true, tabs are scrollable and the tab width is based on the label width.
  bool get scrollable => jsElement['scrollable'];
  set scrollable(bool value) { jsElement['scrollable'] = value; }

  /// If true, scroll buttons (left/right arrow) will be hidden for scrollable tabs.
  bool get hideScrollButton => jsElement['hideScrollButton'];
  set hideScrollButton(bool value) { jsElement['hideScrollButton'] = value; }

  /// If true, dragging on the tabs to scroll is disabled.
  bool get disableDrag => jsElement['disableDrag'];
  set disableDrag(bool value) { jsElement['disableDrag'] = value; }
