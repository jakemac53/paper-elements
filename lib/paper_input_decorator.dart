...
class PaperInputDecorator extends HtmlElement with DomProxyMixin {
  ...
  bool get labelVisible => jsElement['labelVisible'];
  set labelVisible(bool value) { jsElement['labelVisible'] = value; }

  /// Set this property to true to show the error message.
  bool get isInvalid => jsElement['isInvalid'];
  set isInvalid(bool value) { jsElement['isInvalid'] = value; }
